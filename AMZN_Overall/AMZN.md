...
<details><summary>第三方卖家热卖品牌</summary>
<p>
1.Beding
...
<details><summary>Search By Products</summary>
<p>
选择品类和criteria包括以下内容

| <div style="width:120px"> Categories </div> | Month Revenue|<div style="width:60px"> Price </div>|Review Count|Review Rating|
| :---: |:---:| :---:|:---:|:---:|
|Home & Kitchen| 5000+ | 15～50 | 20~1100 | ~4.5 | 

* Price取值范围的思考
  * Why 15 as lower bound? 因为15以下利润太低。
  * Why 50 as upper bound? 因为50以下的产品用户购物压力不大
* Review取值范围的思考
 * Why 20 as lower bound? It indicates the needs.
 * Why 1100 as upper bound? It indicates that there are sellers who become monopoly in this area where new investments would turn to be less meaningful.
...
* If the sum of top 3 sales occupies over 30% of the total sales among the top 10, this means there is a monopoly circumstance and it would not be meaningful to invest the product. If the review velocity is high (~2000), this stands for the product is under hot sell and it is not what we want. If the review velocity is minus, this means the Amazon is removing some comments which are considered as hacked reviews. Getting involved might be troublesome.
...
<details><summary>Search By Keywords</summary>
<p>
选择品类和criteria 包括以下内容

| <div style="width:120px"> Search Volume </div> | Month Revenue|<div style="width:60px"> Price </div>|Review Count|Review Rating|Word Count|
| :---: |:---:| :---:|:---:|:---:|:---:|
|5000| 5000+ | 15～50 | 20~1100 | ~4.5 | 2|
...
<details><summary>more on FBA头程</summary>
<p>

1. 直发快递：DHL、UPS、Fedex之类的，价格最贵，但时效快，适合紧急补货。但是要注意Amazon不作为清关主体，不负责清关和缴税，一定要做好申报和关税预付并且提前准备好当地清关进口商。

2. FBA空+派：使用空运先运到当地，再使用当地快递派送至Amazon仓库，时效快，略比直发快递慢一些。现在市面上的空+派一般是双清包税的，也不需要支付关税预付费用等，费用适中。

3. FBA海运头程：海运+当地清关+目的国派送，时效略微长点。海运头程时效长，一般要一个月及以上，但是价格便宜，更适合的是旺季大批量补货或者有稳定销量的产品。

打包的注意事项

1.箱子一定要完好无损，中性包装，尽量贴透明胶带。

2.产品一定不能贴错标

3.箱子包装尺寸最长边不能超过70cm,重量不能超过50磅。

4.产品如果混装一定要填好装箱资料

5.外箱标签一定要贴好

6.需要有Made In China的标签
</p>
</details>
...
4.They also handle returns (do charge return process fee) and refunds
Cons of FBA:
1.FBA costs money for both storage and fulfillment fee.
2.Long-term storage fees active once the goods sit there for over 6 months
3.More returns due to easy return mechanism and customer test buying.
4.Harder tax rules since Amazon is going to sell your products in different states (Avalara)
</p>
</details>
